...
//Primero hago la llamada para crear libros si no hay en la bd
(new Libros)->crearLibro(15);

//Me guardo en una varibale todos los libros para poder mostrarlos luego
...
<body style="background-color: #E3B98A;">

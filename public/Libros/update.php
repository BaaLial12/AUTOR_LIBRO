...
//Comprobamos que existe el id que recibimos por GET y lo hemos guardado 
if(!Libros::ExisteLibroId($id)){
    header("Location:index.php");
    die();
}
...
if (isset($_POST['crear'])) {
    ...
    //Si salimos de todo lo anterior en teoria ha ido bine y actualizo el libro
        ...
        <div class="container">
            <form action="<?php echo $_SERVER['PHP_SELF']."?id=$id"; ?>" enctype="multipart/form-data" method="POST" class="mx-auto bg-secondary px-4 py-4 rounded" style="width: 40rem;">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="nombre" class="form-control" placeholder="Titulo" name="nombre" value="<?php echo $libro->titulo ?>" required />
                    <?php
                    MostrarError('titulo')
                    ?>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <select name="autor" class="form-select">
                        <?php
                        foreach ($autores as $autorr) {
                            $control = ($libro->autor==$autorr->id_autor) ? "selected" : "";
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="isbn" class="form-control" placeholder="ISBN" name="isbn" required value="<?php echo $libro->isbn ?>" >
                    <?php
                    MostrarError('isbn')
                    ?>
                </div>

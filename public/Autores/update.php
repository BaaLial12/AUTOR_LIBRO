...
//Comprobacion del id que existe
$id = $_GET['id'];
require __DIR__."/../../vendor/autoload.php";
use Src\Autores;

//Comprobamos que existe el id que recibimos por GET y la hemos guardado 
...
//Si salimos de todo lo anterior significa:
//El autor existe y el autor ha sido mandado por id
$autor = (new Autores)->setId_autor($id)->read();



//Creacion de una funcion para pintar Errores
...
//Si le ha dado al boton Actualizar , entonces comporbamos los campos
...
$error = false;
    ...
    //Si sale de las comprobacion entonces significa que esta bien y entonces podremos actualizarlo
    (new Autores) ->setNombre($nombre)->setApellidos($apellido)->update($id);
